...
<td><form:input path="stock" id="stock_fr"/></td>
</tr>

<tr>
<td>Product Price</td>

<td><form:input path="price" id="price_fr"/></td>
</tr>
...
<form:options items="${categoryList}" id="category"/>
</form:select>
</td>
</tr>
...
<td>${product.stock}</td>
<td>${product.price}</td>
<td>${categoryList[product.catId]}</td>
<td>$${supplierList[product.supplierId]}</td>
<security:authorize access="hasRole('ROLE_ADMIN')">
